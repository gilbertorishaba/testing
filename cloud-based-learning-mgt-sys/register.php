...
<head>
    ...
    <title>Register - Cloud LMS</title>
    <style>
        body {
        ...
        .register-container {
            margin-top: 100px; /* Adjust top margin for better visibility */
            max-width: 500px;
        ...
        .register-container h2 {
            margin-bottom: 20px;
            color: #4CAF50; /* Makerere theme color */
        }
        .form-control {
            border-radius: 50px;
            padding: 10px 15px;
    ...
    .form-group label {
        color: #000; /* Set to black or a dark color for better visibility */
    }
...
<nav class="navbar navbar-expand-lg navbar-light fixed-top">
    <div class="container">
        <a class="navbar-brand" href="index.php">
            <img src="images/img3 (2).jpg" alt=" LAITI LMS  " width="40" height="40"> LAITI LMS
        </a>
    ...
    <div class="container d-flex justify-content-center">
        <div class="register-container">
            <h2 class="text-center">Register for Cloud LMS</h2>
            <?php if (isset($error)): ?>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-4">
                    ...
                    <p>Cloud LMS is a cutting-edge platform designed to provide quality education from the comfort of your home. We offer a range of interactive courses and advanced learning tools to help you succeed.</p>

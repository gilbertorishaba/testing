...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if ($result->num_rows > 0) {
        ...
        // Simplified password check (no hashing)
...
<div id="carouselExampleCaptions" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner">
        ...
        <div class="carousel-inner">
        <div class="carousel-item active">
            <img src="images/" class="d-block w-100" alt="First Slide">
            <div class="carousel-caption d-none d-md-block">
                <h5>Cloud-Based Learning</h5>
                <p>Access quality education anywhere, anytime.</p>
            </div>
        ...
        <div class="carousel-item">
            <img src="images/img3 (2).jpg" class="d-block w-100" alt="Second Slide">
            <div class="carousel-caption d-none d-md-block">
        ...
        <div class="carousel-item">
            <img src="images/img2 (2).jpg" class="d-block w-100" alt="Third Slide">
            <div class="carousel-caption d-none d-md-block">
...
<div class="container d-flex justify-content-center">
    <div class="login-container" id="loginForm" style="display:none;">
        <h2 class="text-center">Login to Cloud LMS</h2>
...
<section class="container my-5">
    <h2 class="text-center mb-4">Accessing Cloud LMS</h2>
    <p class="text-center">
        Accessing our Cloud LMS is easy and convenient. Simply follow these steps:
    </p>
